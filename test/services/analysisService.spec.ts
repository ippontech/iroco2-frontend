...
describe("AnalysisService", () => {
  ...
  describe("getAnalysisById", () => {
    ...
    it("should calculate 100% percentage when analysis has single payload", async () => {
      // given
      ...
      // then
      expect(result.totalCO2Gr).toBe(1000);
      expect(result.relativeCarbonFootprintList).toHaveLength(1);
      expect(result.relativeCarbonFootprintList[0].percentage).toBe(100);
    });
